import type {
  ...
  describe(
    ...
    () => {
      it(
        "deve registrar a conclusão da reunião e executar o ciclo comercial sem transição",
        () => {
      ...
      it(
        ...
        () => {
          ...
          expect(() =>
            ...
            "O ID do workspace é obrigatório para concluir a reunião.",
          )
      ...
      it(
        ...
        () => {
          ...
          expect(() =>
            ...
            "O ID da jornada comercial é obrigatório para concluir a reunião.",
          )
