import type {
  ...
  describe(
    ...
    () => {
      it(
        "deve registrar a aceitação da proposta comercial e executar o ciclo comercial sem transição",
        () => {
      ...
      it(
        ...
        () => {
          ...
          expect(() =>
            ...
            "O ID do workspace é obrigatório para aceitar a proposta comercial.",
          )
      ...
      it(
        ...
        () => {
          ...
          expect(() =>
            ...
            "O ID da jornada comercial é obrigatório para aceitar a proposta comercial.",
          )
