...
export type CreateOpportunityOptions = {
  ...
  publishEvent?: (event: CommercialEvent) => void
}
...
export type CreateOpportunityAsyncDependencies =
  ...
  Pick<
    AsyncCommercialRepositories,
    "journeys" | "phases" | "states" | "transactions"
  >
...
function generateDefaultEventId(): string {
...
export class CreateOpportunityAsync {
  ...
  async execute(
    ...
    const generateEventId =
      this.options.generateEventId ??
      generateDefaultEventId
