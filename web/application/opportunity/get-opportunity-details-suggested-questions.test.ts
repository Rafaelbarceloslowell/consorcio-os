...
describe(
  "GetOpportunityDetailsAsync Suggested Questions",
  () => {
    it(
      "entrega as quatro perguntas usando o contexto aprovado da oportunidade",
      async () => {
        const result =
        ...
        expect(
          result.opportunity.suggestedQuestions,
        ).toEqual([
          {
            kind: "situation",
            label: "Situação",
