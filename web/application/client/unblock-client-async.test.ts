...
describe(
  ...
  () => {
    it(
      "desbloqueia um cliente bloqueado",
      async () => {
        const {
          subject,
        } =
    ...
    it(
      ...
      async () => {
        ...
        await expect(
          ...
          'Cliente não encontrado para o ID "client-unblock-async".',
        )
    ...
    it(
      "rejeita o desbloqueio de um cliente inativo",
      async () => {
        const {
          subject,
          update,
    ...
    it(
      ...
      async () => {
        ...
        await expect(
          ...
          'O cliente "client-unblock-async" não pôde ser atualizado.',
        )
      },
    )
