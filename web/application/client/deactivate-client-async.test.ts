...
describe(
  ...
  () => {
    ...
    it(
      ...
      async () => {
        ...
        await expect(
          ...
          'Cliente não encontrado para o ID "client-deactivate-async".',
        )
    ...
    it(
      "permite desativar um cliente bloqueado",
      async () => {
        const {
          subject,
          update,
    ...
    it(
      ...
      async () => {
        ...
        await expect(
          ...
          'O cliente "client-deactivate-async" não pôde ser atualizado.',
        )
      },
    )
